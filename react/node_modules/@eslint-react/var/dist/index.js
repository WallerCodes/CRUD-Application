...
function resolveObjectType(context, node) {
	...
	switch (node.type) {
		...
		case AST_NODE_TYPES.CallExpression: {
			...
			if (callee.type === AST_NODE_TYPES.MemberExpression && Check.isIdentifier(callee.object)) {
				...
				switch (objName) {
					case "Array":
						...
						break;
					case "Object": if (methodName === "create" || methodName === "assign" || methodName === "fromEntries") return {
						kind: "plain",
						node
					};
				}
