<%@ Page Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" Inherits="EditOrCopyConfig" Title="Configuration | BPCM" %>

<%@ MasterType VirtualPath="./MasterPage.master" %>

<asp:Content ID="CustomCSS_Config" ContentPlaceHolderID="CustomCSS" runat="Server">
    <%: System.Web.Optimization.Styles.Render("~/bundles_css/EditOrCopyConfig") %>
</asp:Content>

<asp:Content ID="CustomJS_Config" ContentPlaceHolderID="CustomJS" runat="Server">
    <%: System.Web.Optimization.Scripts.Render("~/bundles_js/EditOrCopyConfig") %>
</asp:Content>
                        ...
                        <div class="col s12">
                            ...
                            <div class="u-container-left" style="padding: 0px 10px 0px 10px; margin-top: -10px; margin-right: 1em;">
                                ...
                                <div class="row" style="margin-bottom: 1.5em;">
                                    ...
                                    <div class="col s2">
                                        <div id="email-honeypot" class="call-seq-input input-field">
                                            <input type="search" id="u-config-form-email" autocomplete="off">
                                            <label for="u-config-form-email">Email</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-bottom: 1.5em; height: 60px">
                                    <a class="bypass-button" id="save-button">SAVE</a>
