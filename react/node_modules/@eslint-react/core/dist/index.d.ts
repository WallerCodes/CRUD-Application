...
//#endregion
//#region src/create-element.d.ts
/**
 ...
 */
declare function getCreateElementTypeArgument(context: RuleContext, node: null | TSESTree.Node): TSESTree.CallExpressionArgument | null;
/**
 ...
 */
declare function getCreateElementPropsObject(context: RuleContext, node: null | TSESTree.Node): TSESTree.ObjectExpression | null;
/**
 ...
 */
declare function getCreateElementChildrenArguments(context: RuleContext, node: null | TSESTree.Node): TSESTree.CallExpressionArgument[];
/**
 ...
 * ```
 */
declare function getCreateElementProp(context: RuleContext, node: null | TSESTree.Node, name: string): TSESTree.Property | null;
/**
 ...
 */
declare function isCreateElementChildrenArgument(context: RuleContext, node: TSESTree.Node): boolean;
/**
 ...
 */
declare function isHookTag(tag: TSESTree.Node | null): boolean;
/**
 ...
 */
declare function isUseRefLikeCall(node: TSESTree.Node | null, additionalRefHooks?: RegExpLike): node is TSESTree.CallExpression;
/**
