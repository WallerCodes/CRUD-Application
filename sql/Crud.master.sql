...
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
GO
/* drop table [crud].[languages] */
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
-- TABLE CREATION --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if not exists(select * from sys.tables where name = 'languages' and schema_id = (select schema_id from sys.schemas where name = 'crud'))
begin
   print 'Creating languages table'
   create table [crud].[languages] (
...
-- NULL CONSTRAINTS --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if exists (select * from sys.columns where object_id = object_id('[crud].[languages]') and name = 'languageId' and is_nullable=1)
begin
   print 'Converting column languageId in languages to disallow nulls'
   alter table [crud].[languages] alter column [languageId] int not null
end
else
begin
   print '	Column languageId already in languages already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[languages]') and name = 'language' and is_nullable=1)
begin
   print 'Converting column language in languages to disallow nulls'
   alter table [crud].[languages] alter column [language] varchar(35) not null
end
else
begin
...
@addComm as varchar (max),
@addComm2 as varchar (max)
select @idxIsUnique=is_unique, @idxIsUniqueConstraint=is_unique_constraint, @idxIsPKConstraint=is_primary_key, @idxType=type from sys.indexes where object_id = object_id('[crud].[languages]') and name = 'languagesPrimaryKey'
set @idxExists = case when @idxType is null then 0 else 1 end
set @idxIsClustered = case when @idxType = 1 then 1 else 0 end
set @idxIsUnique = isnull(@idxIsUnique, 0)
set @idxIsUniqueConstraint = isnull(@idxIsUniqueConstraint, 0)
...
begin
   ...
   alter table [crud].[languages] add constraint [languagesPrimaryKey] primary key clustered (
      [languageId] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF ) on [PRIMARY]
end
...
begin
   ...
   alter table [crud].[languages] drop constraint [languagesPrimaryKey]
   alter table [crud].[languages] add constraint [languagesPrimaryKey] primary key clustered (
      [languageId] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF ) on [PRIMARY]
...
select @idxIsUnique=is_unique, @idxIsUniqueConstraint=is_unique_constraint, @idxIsPKConstraint=is_primary_key, @idxType=type from sys.indexes where object_id = object_id('[crud].[languages]') and name = 'languageIndex'
set @idxExists = case when @idxType is null then 0 else 1 end
set @idxIsClustered = case when @idxType = 1 then 1 else 0 end
set @idxIsUnique = isnull(@idxIsUnique, 0)
set @idxIsUniqueConstraint = isnull(@idxIsUniqueConstraint, 0)
...
begin
   ...
   create unique nonclustered index [languageIndex] on [crud].[languages] (
      [language] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF, FILLFACTOR = 70 ) on [PRIMARY]
end
...
begin
   ...
   alter table [crud].[languages] drop constraint [languageIndex]
   create unique nonclustered index [languageIndex] on [crud].[languages] (
      [language] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF, FILLFACTOR = 70 ) on [PRIMARY]
...
-- TABLE CREATION --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if not exists(select * from sys.tables where name = 'users' and schema_id = (select schema_id from sys.schemas where name = 'crud'))
begin
...
-- NULL CONSTRAINTS --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'userId' and is_nullable=1)
begin
   print 'Converting column userId in users to disallow nulls'
   alter table [crud].[users] alter column [userId] int not null
end
else
begin
   print '	Column userId already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'userName' and is_nullable=1)
begin
   print 'Converting column userName in users to disallow nulls'
   alter table [crud].[users] alter column [userName] varchar(100) not null
end
else
begin
   print '	Column userName already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'deleted' and is_nullable=1)
begin
   print 'Converting column deleted in users to disallow nulls'
   alter table [crud].[users] alter column [deleted] bit not null
end
else
begin
   print '	Column deleted already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'password' and is_nullable=1)
begin
   print 'Converting column password in users to disallow nulls'
   alter table [crud].[users] alter column [password] varchar(256) not null
end
else
begin
   print '	Column password already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'disabled' and is_nullable=1)
begin
   print 'Converting column disabled in users to disallow nulls'
   alter table [crud].[users] alter column [disabled] bit not null
end
else
begin
   print '	Column disabled already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'isSuperAdmin' and is_nullable=1)
begin
   print 'Converting column isSuperAdmin in users to disallow nulls'
   alter table [crud].[users] alter column [isSuperAdmin] bit not null
end
else
begin
   print '	Column isSuperAdmin already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'isUsanUser' and is_nullable=1)
begin
   print 'Converting column isUsanUser in users to disallow nulls'
   alter table [crud].[users] alter column [isUsanUser] bit not null
end
else
begin
   print '	Column isUsanUser already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'lastLoginDate' and is_nullable=0)
begin
   print 'Converting column lastLoginDate in users to allow nulls'
   alter table [crud].[users] alter column [lastLoginDate] datetime null
end
else
begin
   print '	Column lastLoginDate already in users already allows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'locked' and is_nullable=1)
begin
   print 'Converting column locked in users to disallow nulls'
   alter table [crud].[users] alter column [locked] bit not null
end
else
begin
   print '	Column locked already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'failedLoginAttempts' and is_nullable=1)
begin
   print 'Converting column failedLoginAttempts in users to disallow nulls'
   alter table [crud].[users] alter column [failedLoginAttempts] smallint not null
end
else
begin
   print '	Column failedLoginAttempts already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'lastPasswordChangeDate' and is_nullable=0)
begin
   print 'Converting column lastPasswordChangeDate in users to allow nulls'
   alter table [crud].[users] alter column [lastPasswordChangeDate] datetime null
end
else
begin
   print '	Column lastPasswordChangeDate already in users already allows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'forceChangePassword' and is_nullable=1)
begin
   print 'Converting column forceChangePassword in users to disallow nulls'
   alter table [crud].[users] alter column [forceChangePassword] bit not null
end
else
begin
   print '	Column forceChangePassword already in users already disallows nulls'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'dateAdded' and is_nullable=1)
begin
   print 'Converting column dateAdded in users to disallow nulls'
   alter table [crud].[users] alter column [dateAdded] datetime not null
end
else
begin
...
-- DEFAULT CONSTRAINTS --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'deleted' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.deleted'
   alter table [crud].[users] add constraint [usersDeletedDefault] default ((0)) for [deleted]
end
else
begin
   print 'Default constraint already exists for users.deleted'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'disabled' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.disabled'
   alter table [crud].[users] add constraint [usersDisabledDefault] default ((0)) for [disabled]
end
else
begin
   print 'Default constraint already exists for users.disabled'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'isSuperAdmin' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.isSuperAdmin'
   alter table [crud].[users] add constraint [usersIsSuperAdminDefault] default ((0)) for [isSuperAdmin]
end
else
begin
   print 'Default constraint already exists for users.isSuperAdmin'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'isUsanUser' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.isUsanUser'
   alter table [crud].[users] add constraint [usersIsUsanUserDefault] default ((0)) for [isUsanUser]
end
else
begin
   print 'Default constraint already exists for users.isUsanUser'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'locked' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.locked'
   alter table [crud].[users] add constraint [usersLockedDefault] default ((0)) for [locked]
end
else
begin
   print 'Default constraint already exists for users.locked'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'failedLoginAttempts' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.failedLoginAttempts'
   alter table [crud].[users] add constraint [usersFailedLoginAttemptsDefault] default ((0)) for [failedLoginAttempts]
end
else
begin
   print 'Default constraint already exists for users.failedLoginAttempts'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'forceChangePassword' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.forceChangePassword'
   alter table [crud].[users] add constraint [usersForceChangePasswordDefault] default ((0)) for [forceChangePassword]
end
else
begin
   print 'Default constraint already exists for users.forceChangePassword'
end
if exists (select * from sys.columns where object_id = object_id('[crud].[users]') and name = 'dateAdded' and [default_object_id]=0)
begin
   print 'Creating default constraint on users.dateAdded'
   alter table [crud].[users] add constraint [usersDateAddedDefault] default (getdate()) for [dateAdded]
end
else
begin
...
@addComm as varchar (max),
@addComm2 as varchar (max)
select @idxIsUnique=is_unique, @idxIsUniqueConstraint=is_unique_constraint, @idxIsPKConstraint=is_primary_key, @idxType=type from sys.indexes where object_id = object_id('[crud].[users]') and name = 'usersIndex'
set @idxExists = case when @idxType is null then 0 else 1 end
set @idxIsClustered = case when @idxType = 1 then 1 else 0 end
set @idxIsUnique = isnull(@idxIsUnique, 0)
set @idxIsUniqueConstraint = isnull(@idxIsUniqueConstraint, 0)
...
begin
   ...
   create unique nonclustered index [usersIndex] on [crud].[users] (
      [userName] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF, FILLFACTOR = 70 ) on [PRIMARY]
end
...
begin
   ...
   alter table [crud].[users] drop constraint [usersIndex]
   create unique nonclustered index [usersIndex] on [crud].[users] (
      [userName] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF, FILLFACTOR = 70 ) on [PRIMARY]
...
select @idxIsUnique=is_unique, @idxIsUniqueConstraint=is_unique_constraint, @idxIsPKConstraint=is_primary_key, @idxType=type from sys.indexes where object_id = object_id('[crud].[users]') and name = 'usersPrimaryKey'
set @idxExists = case when @idxType is null then 0 else 1 end
set @idxIsClustered = case when @idxType = 1 then 1 else 0 end
set @idxIsUnique = isnull(@idxIsUnique, 0)
set @idxIsUniqueConstraint = isnull(@idxIsUniqueConstraint, 0)
...
begin
   ...
   alter table [crud].[users] add constraint [usersPrimaryKey] primary key clustered (
      [userId] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF ) on [PRIMARY]
end
...
begin
   ...
   alter table [crud].[users] drop constraint [usersPrimaryKey]
   alter table [crud].[users] add constraint [usersPrimaryKey] primary key clustered (
      [userId] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF ) on [PRIMARY]
...
GO
/* drop table [crud].[ivrSearchTrace] */
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
-- TABLE CREATION --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if not exists(select * from sys.tables where name = 'ivrSearchTrace' and schema_id = (select schema_id from sys.schemas where name = 'crud'))
begin
   print 'Creating ivrSearchTrace table'
   create table [crud].[ivrSearchTrace] (
...
-- NULL CONSTRAINTS --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if exists (select * from sys.columns where object_id = object_id('[crud].[ivrSearchTrace]') and name = 'ivrSearchTraceId' and is_nullable=1)
begin
   print 'Converting column ivrSearchTraceId in ivrSearchTrace to disallow nulls'
   alter table [crud].[ivrSearchTrace] alter column [ivrSearchTraceId] int not null
end
else
begin
...
-- DEFAULT CONSTRAINTS --
--$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########$$$$$$$$$$$###########--
if exists (select * from sys.columns where object_id = object_id('[crud].[ivrSearchTrace]') and name = 'dateAdded' and [default_object_id]=0)
begin
   print 'Creating default constraint on ivrSearchTrace.dateAdded'
   alter table [crud].[ivrSearchTrace] add constraint [ivrSearchTraceDateAddedDefault] default (getdate()) for [dateAdded]
end
else
begin
...
@addComm as varchar (max),
@addComm2 as varchar (max)
select @idxIsUnique=is_unique, @idxIsUniqueConstraint=is_unique_constraint, @idxIsPKConstraint=is_primary_key, @idxType=type from sys.indexes where object_id = object_id('[crud].[ivrSearchTrace]') and name = 'ivrSearchTracePrimaryKey'
set @idxExists = case when @idxType is null then 0 else 1 end
set @idxIsClustered = case when @idxType = 1 then 1 else 0 end
set @idxIsUnique = isnull(@idxIsUnique, 0)
set @idxIsUniqueConstraint = isnull(@idxIsUniqueConstraint, 0)
...
begin
   ...
   alter table [crud].[ivrSearchTrace] add constraint [ivrSearchTracePrimaryKey] primary key clustered (
...
begin
   ...
   alter table [crud].[ivrSearchTrace] drop constraint [ivrSearchTracePrimaryKey]
   alter table [crud].[ivrSearchTrace] add constraint [ivrSearchTracePrimaryKey] primary key clustered (
      [ivrSearchTraceId] ASC
   )
   with ( PAD_INDEX = OFF, ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, SORT_IN_TEMPDB = OFF ) on [PRIMARY]
...
BEGIN
 ...
 EXECUTE ('create procedure [crud].[GetUsers] as select 1')
END
GO
PRINT 'Altering stored procedure GetUsers to latest version'
GO
ALTER PROCEDURE [crud].[GetUsers] (
...
if not exists (select * from sys.procedures where name = 'UpdateUserRoles' and schema_name(schema_id) = 'crud')
begin
   print 'Creating emtpy UpdateUserRoles stored procedure'
   execute('create procedure [crud].[UpdateUserRoles] as select 1')
end
GO
print 'Altering stored procedure UpdateUserRoles to latest version'
GO
ALTER PROCEDURE [crud].[UpdateUserRoles] (
 @userId INT
...
if not exists (select * from sys.procedures where name = 'GetConfigurations' and schema_name(schema_id) = 'crud')
begin
   print 'Creating emtpy GetConfigurations stored procedure'
   execute('create procedure [crud].[GetConfigurations] as select 1')
end
GO
print 'Altering stored procedure GetConfigurations to latest version'
GO
ALTER PROCEDURE [crud].[GetConfigurations] (
 @userName VARCHAR(64)
...
FROM [crud].[configurations] AS [configs]
JOIN [crud].[applications] AS [apps] ON [apps].[applicationId] = [configs].[applicationId]
LEFT JOIN [crud].[languages] AS [langs] ON [langs].[languageId] = [configs].[languageId]
JOIN [crud].[users] AS [users] ON [users].[userName] = @userName
...
if not exists (select * from sys.procedures where name = 'GetUserAuditHistory' and schema_name(schema_id) = 'crud')
begin
   print 'Creating emtpy GetUserAuditHistory stored procedure'
   execute('create procedure [crud].[GetUserAuditHistory] as select 1')
end
GO
print 'Altering stored procedure GetUserAuditHistory to latest version'
GO
ALTER PROCEDURE [crud].[GetUserAuditHistory] (
 @start INT
 ,@limit INT
 ,@affectedUserName VARCHAR(100)
 ,@performerUserName VARCHAR(100)
 ...
 BEGIN
  ...
  FROM (
   ...
   FROM (
    ...
    FROM crud.userAudits AS userAudits
    JOIN crud_static.userAuditActions ON crud_static.userAuditActions.userAuditActionId = userAudits.userAuditActionId
    LEFT OUTER JOIN crud.users AS performerUser ON performerUser.userId = performerUserId
    LEFT OUTER JOIN crud.users AS affectedUser ON affectedUser.userId = affectedUserId
    WHERE (
      @affectedUserName IS NULL
      OR affectedUser.userName LIKE '%' + @affectedUserName + '%'
      )
...
if not exists (select * from sys.procedures where name = 'IvrSearchConfigs' and schema_name(schema_id) = 'crud')
begin
   print 'Creating emtpy IvrSearchConfigs stored procedure'
   execute('create procedure [crud].[IvrSearchConfigs] as select 1')
end
GO
print 'Altering stored procedure IvrSearchConfigs to latest version'
GO
alter procedure [crud].[IvrSearchConfigs](
 @appname varchar(32),
 @language varchar(32) = '*',
 @dnis as varchar(32) = '*',
...
FROM [crud].[configurations] as [configs]
JOIN [crud].[applications] as [apps]
 ON [apps].[applicationId] = [configs].[applicationId]
LEFT OUTER JOIN [crud].[languages] as [langs]
 ON [langs].[languageId] = [configs].[languageId]
JOIN [crud].[users] as [users]
...
begin
 print 'Adding initial static data for [crud_static].[userAuditActions]'
 set identity_insert [crud_static].[userAuditActions] on
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (1, N'Add User', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (2, N'Delete User', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (3, N'Update User', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (4, N'Add Role', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (5, N'Delete Role', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (6, N'Update Role', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (7, N'Failed Login', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (8, N'Login', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (9, N'Change User Role', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (10, N'Create Configuration', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (11, N'Edit Configuration', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (12, N'Copy Configuration', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (13, N'Delete Configuration', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (14, N'Update Configuration Order', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (15, N'Change Password', GETDATE())
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded]) values (16, N'Reset Password', GETDATE())
 set identity_insert [crud_static].[userAuditActions] off
end
if not exists (select * from [crud_static].[userAuditActions] where [userAuditActionId] = 1)
begin
 ...
 begin transaction
 set identity_insert [crud_static].[userAuditActions] on
 insert [crud_static].[userAuditActions] ([userAuditActionId], [auditDescription], [dateAdded])
